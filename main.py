...
# Topics
topic_measurement = "fhnw/oberstufe/5/measurement"
topic_connectionhistory = "fhnw/oberstufe/5/connectionhistory"
topic_peoplecounter = "fhnw/oberstufe/6/entranceevent"
                ...
                while connection.connected:
                    ...
                    if message != None:
                        ...
                        if message != "":
                            ...
                            print("loading the pay", payload)
                            # attempt to publish this data to the topic.
                            try:
                                print(data["co2"] == None, data ["temperature"] == None, data["humidity"] == None,  data["motion"] == None, data["light"] == None)
...
def peoplecounter():
    ...
    def person_infront(sensor):
        if sensor == "right":
            return max(right_arr) > 500 or min(right_arr) < 180
        elif sensor == "left":
            return max(left_arr) > 500 or min(left_arr) < 180
        else:
